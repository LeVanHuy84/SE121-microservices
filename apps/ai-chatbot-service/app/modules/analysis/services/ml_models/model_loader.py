...
class ModelLoader:
    ...
    def initialize(self):
        ...
        try:
            from app.modules.analysis.services.ml_models.image_understanding import ensure_clip_loaded
            ensure_clip_loaded()
        ...
        try:
            from app.modules.analysis.services.ml_models.text_emotion import ensure_phobert_emotion_loaded
        ...
        try:
            from app.modules.analysis.services.ml_models.image_emotion import ensure_fer_loaded
            ensure_fer_loaded()
        ...
        try:
            from app.modules.analysis.services.ml_models.music import ensure_music_model_loaded
    ...
    def health_check(self) -> dict:
        ...
        try:
            from app.modules.analysis.services.ml_models.image_understanding import clip_loader
            status["clip"] = clip_loader.is_loaded()
        except Exception:
            pass
        
        try:
            from app.modules.analysis.services.ml_models.text_emotion import phobert_emotion_model
            status["text_emotion"] = phobert_emotion_model.is_loaded()
        except Exception:
            pass
        
        try:
            from app.modules.analysis.services.ml_models.image_emotion import fer_analyzer
        ...
        try:
            from app.modules.analysis.services.ml_models.image_moderation import unsafe_scene_detector
        ...
        try:
            from app.modules.analysis.services.ml_models.music import music_model_loader
