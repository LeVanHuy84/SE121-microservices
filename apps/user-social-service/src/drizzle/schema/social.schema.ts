...
export const friendRequests = pgTable(
  'friend_requests',
  {
    ...
    recommendationRequestId: varchar('recommendation_request_id', { length: 255 }),
...
export type FriendRecommendationDismissal = typeof friendRecommendationDismissals.$inferSelect;
export type NewFriendRecommendationDismissal = typeof friendRecommendationDismissals.$inferInsert;

export type FriendRecommendationEvent = typeof friendRecommendationEvents.$inferSelect;
export type NewFriendRecommendationEvent = typeof friendRecommendationEvents.$inferInsert;
